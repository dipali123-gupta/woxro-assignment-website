      ...
      <div style={{ padding: "20px" }}>
        ...
        >
          <div style={{ display: "flex" , paddingLeft:"40px" , paddingTop:"45px"}}>
            <img
              src="https://www.xentice.com/static/media/commercial_space.cabcda3f.png"
              width="30"
              height="30"
              
            />
            <div style={{paddingLeft:"10px"}}>
            <Typography variant="h6" component="div">Commercial Shop</Typography>
            </div>
          </div>
        </Box>
      </div>
        ...
        <div style={card}>
          <Card sx={{ width: 270 }}>
            <CardMedia
              component="img"
              height="200"
              image="https://www.nanubhaiproperty.com/images/thumbs/property/485092_250-sq-ft-commercial-shop-for-sale-andheri-east-in-mumbai_400.jpeg"
              alt="green iguana"
            />
            <CardContent>
